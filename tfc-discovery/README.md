...
======================================================
  ...
  - old-app  (has state, last run 412 days ago)
  - imported-manually  (has state, never run)
[INFO] These have resources under management but haven't been run recently - worth checking whether
...
```
TFC Project,Workspace,Has State,Depends On,Dependents,Dependent Count,Recommendation,Last Run,Days Since Last Run,Stale
Networking,network-hub,Yes,,app-1; app-2,2,Migrate first - 2 dependents,2026-07-10T12:00:00Z,3,No
Applications,app-1,Yes,network-hub,app-2,1,Migrate first - 1 dependent,2025-06-01T09:00:00Z,412,Yes
